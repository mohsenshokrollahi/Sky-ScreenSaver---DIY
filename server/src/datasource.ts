...
import { lookupAirline } from "./enrich/airlines.js";
import { lookupType } from "./enrich/types.js";
...
export class Poller {
  ...
  /** Tracks whether the previous poll cycle failed, to detect recovery. */
  private wasFailingPoll = false;
