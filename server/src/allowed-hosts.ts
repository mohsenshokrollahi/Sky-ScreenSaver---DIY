...
//
// Defaults are tuned for New Skyline's documented topology:
...
//   - *.local                        (mDNS, e.g. new-skyline.local)
//
// Operators that expose New Skyline on a public hostname can add it via the
